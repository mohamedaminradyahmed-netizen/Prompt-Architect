...
- [x] Modify engineerPrompt function to generate 3 variations using mutations
- [x] Apply evaluation heuristics to score each variation
- [x] Sort suggestions by score and select top 3
